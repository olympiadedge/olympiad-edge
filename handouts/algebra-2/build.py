#!/usr/bin/env python3
"""
Build script for Algebra II Competition Handout.
...
CHAPTERS = [
    "preamble.typ",
    "ch01-polynomials.typ",
    "ch02-quadratics.typ",
    "ch03-sequences-series.typ",
    "ch04-exponents-logs.typ",
    "ch05-complex-numbers.typ",
    "ch06-inequalities.typ",
    "ch07-special-factorizations.typ",
    "ch08-functions.typ",
    "ch09-floor-ceiling.typ",
    "ch10-competition-problems.typ",
    "formula-sheet.typ",
]

OUTPUT_TYP = "_build.typ"
OUTPUT_PDF = "Algebra_II_Olympiad_Edge.pdf"
