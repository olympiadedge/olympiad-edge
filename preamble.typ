...
#set document(title: "Putnam Linear Algebra — Olympiad Edge", author: "Olympiad Edge")
#set page(
  paper: "us-letter",
  ...
  header: context {
    if counter(page).get().first() > 2 {
      ...
      grid(
        columns: (1fr, 1fr),
        align(left)[_Olympiad Edge — Putnam Linear Algebra_],
...
#page(header: none, footer: none, margin: (top: 1.8in, bottom: 1in))[
  #align(center)[
    #block(width: 85%, fill: navy, inset: (x: 24pt, y: 28pt), radius: 8pt)[
      ...
      #v(2pt)
      #text(fill: white, size: 18pt)[Linear Algebra]
      #v(10pt)
      ...
      #text(size: 10.5pt, fill: navy)[
        ...
        *Target: Putnam Honorable Mention (48+ points)*
        ...
        #text(size: 9pt, fill: luma(100))[
          Sources: Kedlaya Putnam Archive, Barbeau (U of T), Yufei Zhao (MIT 18.A34), \
          Evan Chen (LAMV, Napkin), AoPS, Cezar Lupu, past Putnam exams 2003–2024.
        ]
      ]
    ]
    #v(12pt)
